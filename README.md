...
채용 공고(JD)와 지원자의 이력서를 기반으로 적합도를 분석하고, 강점/보완점 및 이력서 기반 면접 질문을 자동 생성하는 AI Resume Screening Agent를 구현하였습니다.
...
- 지원자 면접 답변 평가 기능 추가
- 지원자별 순위 비교 테이블 기능 추가
- 결과 데이터 시각화 및 차트 기능 추가
- UI/UX 개선 및 대시보드 고도화
- RAG 기반 면접 질문 추천 기능 추가
- 벡터DB 기반 검색 기능 추가
- 관리자 대시보드 구현
- 지원자 히스토리 저장 기능 추가
