...
생성형 AI 기반 채용 자동화 MVP 프로젝트입니다.  
채용 공고(JD)와 지원자의 이력서를 기반으로 적합도를 분석하고, 강점/보완점/예상 면접 질문을 자동 생성합니다.

---

## 프로젝트 소개

본 프로젝트는 반복적인 채용 운영 업무를 자동화하기 위해 제작한 AI 기반 Resume Screening Agent입니다.

사용자는 채용 공고를 입력하고 여러 지원자의 PDF 이력서를 업로드할 수 있으며, 시스템은 OpenAI API를 활용하여 지원자별 적합도를 분석하고 순위를 제공합니다.
